...
with open("/Users/radhikarawat/PycharmProjects/TCGA_BRCA_exp_HiSeqV2_exon-2015-02-24/probe","U") as gene_probe:
    for gene_row in gene_probe:
        ...
        genes_list.append(gene_row[0])
        bps_list.append(gene_row[1])
...
with open("/Users/radhikarawat/PycharmProjects/TCGA_w_bed/4out_genes2.txt", "w") as gene_output_list:
            for i in range(0,len(bp_row)):
                ...
                try:
                    gene_name=bps_list[genes_list.index(bps)]
                    if gene_name=="":
